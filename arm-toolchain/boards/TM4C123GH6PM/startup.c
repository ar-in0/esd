...
**Copyright(c) 2018,
    Shawn D'silva <shawn@shawndsilva.com> *All rights reserved
                .**This file is free software : you can redistribute it and /
        or modify *it under the terms of the GNU Lesser General Public License
        as published by *the Free Software Foundation,
    either version 3 of the License,
    or *(at your option)any later version.**This file is
...
// __attribute always  applies to the next declaration
__attribute__((section(
    ".vector_table"))) // marks this vector table as a part of the section
                       // "".vector_table"
                       // in the linker script
const vector_table_t vectors[] = {
    {.stack_top = &_stack_ptr}, // 0    Pointer to top of Stack
    Reset_Handler,              // 1    Reset handler is called when
                                // the <RESET> button is pressed
    NMI_Handler,                // 2    Non-Maskable Interrupt handler
    HardFault_Handler,          // 3    Hard Fault Handler
    MemManageFault_Handler,     // 4    Memory management
                                // fault Handler
    ...
    0,                          // 13   Reserved
    PendSV_Handler,             // 14   Pendeable interrupt driven
                                // request
    SysTick_Handler,            // 15   SysTick Timer handler
    GPIOPortA_ISR,              // 16   GPIO Port A Interrupt Service
                                // Routine
    GPIOPortB_ISR,              // 17   GPIO Port B Interrupt Service
                                // Routine
    GPIOPortC_ISR,              // 18   GPIO Port C Interrupt Service
                                // Routine
    GPIOPortD_ISR,              // 19   GPIO Port D Interrupt Service
                                // Routine
    GPIOPortE_ISR,              // 20   GPIO Port E Interrupt Service
                                // Routine
    UART0_ISR,                  // 21   UART 0
    UART1_ISR,                  // 22   UART 1
    SPI0_ISR,                   // 23   SPI 0
